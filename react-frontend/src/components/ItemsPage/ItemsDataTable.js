...
const p_numberTemplate1 = (rowData, { rowIndex }) => <p >{rowData.QuantityItem}</p>
    ...
    const paginatorRight = DownloadCSV({ data : items, fileName : "items"});
...
<Column field="itemName" header="Item name" body={pTemplate0} filter={selectedFilterFields.includes("itemName")} hidden={selectedHideFields?.includes("itemName")}  sortable style={{ minWidth: "8rem" }} />
<Column field="QuantityItem" header="Quantity item" body={p_numberTemplate1} filter={selectedFilterFields.includes("QuantityItem")} hidden={selectedHideFields?.includes("QuantityItem")}  sortable style={{ minWidth: "8rem" }} />
