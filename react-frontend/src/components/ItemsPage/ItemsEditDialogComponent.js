...
QuantityItem: _entity?.QuantityItem,
        };
    ...
    return (
        <Dialog header="Edit Items" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
