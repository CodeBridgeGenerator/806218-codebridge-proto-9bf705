...
const SingleItemsPage = (props) => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Item name</label><p className="m-0 ml-3" >{_entity?.itemName}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Quantity item</label><p className="m-0 ml-3" >{Number(_entity?.QuantityItem)}</p></div>
